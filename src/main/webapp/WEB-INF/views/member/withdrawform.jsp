					...
					<div class="row">
						<div class="container">
							...
							<tbody>
								<tr>
									<td>
										본 이용자가 탈퇴한 경우 모든 개인 정보와 지원 이력 내역 및 진행 전형의 결과를 확인 할 수 없으며 이에 따른 모든 책임은 회원(수험자 및 지원자)이(가) 책임을 진다.
										<br>
										<br>
										- 본 이용자가 탈퇴 시 가입한 이후부터 지원한 회사의 공고 정보 및 지원 내역이 전부 말소되며 이에 따른 모든 책임은 전적으로 회원(수험자 및 지원자)에게 있다.<br>
										- 본 이용자가 마감된 채용 전형 도중 탈퇴를 처리한 경우 전형 중인 공고의 선발 대상에서 제외 된다.<br>
										- 마감 기한 내에 공고를 지원한 지원자가 탈퇴한 경우 재가입 후 동일한 지원서를 작성할 수 있다. 이에 대한 불이익은 없으며 새로운 지원번호가 부여된다.<br>
						...
						$.ajax({
							...
							success : function(data){
								 if(data=="success"){
								    ...
								    $( 'body' ).attr( 'onunload', '' );
									alert("회원탈퇴에 성공했습니다.");
									window.location.href="/member/thankyouforuse";
